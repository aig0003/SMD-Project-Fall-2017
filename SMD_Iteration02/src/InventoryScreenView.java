...
public class InventoryScreenView extends JFrame {
    ...
    private JButton productsButton = new JButton("Edit Products");
    ...
    public InventoryScreenView() {
        ...
        //Set size of buttons
        productsButton.setPreferredSize(new Dimension(BW, BH)); //(buttonWidth, buttonHeight)
    ...
    public JButton getProductsButton() { return productsButton; }
