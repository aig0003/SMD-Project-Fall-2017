...
public class ProductScreenController implements ActionListener {
    ...
    private void saveProduct() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Invalid expiration date format (use 'YYYY-MM-DD').");
            e.printStackTrace();
        }
        ...
        JOptionPane.showMessageDialog(null, "\"" + product.getName() + "\" was updated, restart may be required to take full effect");
    }
}
