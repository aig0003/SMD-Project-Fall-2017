...
public class ProxyProductScreenView extends JFrame {
    ...
    public ProxyProductScreenView(){
        ...
        Employee user = new Employee(); // get the current user here!

        dataAccess = new RestrictedDataAdapter(user, new ProxySQLDataAdapter(serverHostname, portNumber));
    }
