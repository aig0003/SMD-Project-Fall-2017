...
public class ProfileScreenController implements ActionListener {
    ...
    public void editPhoto() {
        ...
        System.out.println("Old image path: " + employee.getProfilePicURL());
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if(type.equals("image")) {
                ...
                System.out.println("New image path: " + employee.getProfilePicURL());
                JOptionPane.showMessageDialog(null, "MESSAGE: Profile picture has been changed! (Re-Login for changes to take effect)");
            } else {
